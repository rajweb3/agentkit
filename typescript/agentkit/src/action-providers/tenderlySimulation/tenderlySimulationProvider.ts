// src/action-providers/tenderly/tenderlySimulationProvider.ts
import { ActionProvider } from "../actionProvider";
import { Network } from "../../network";
import { CreateAction } from "../actionDecorator";
import { SimulateTransactionSchema } from "./schema";
import { EvmWalletProvider } from "../../wallet-providers";
import { z } from "zod";
import { encodeFunctionData, parseAbi } from "viem";

async function encodeContractData(functionSignature: string, args: any[]): Promise<string> {
...
export class TenderlySimulationProvider extends ActionProvider {
  ...
  supportsNetwork = (network: Network): boolean => {
    const supportedNetworks = [
      1, 5, 11155111, // Ethereum + testnets
      137, 80001,     // Polygon + Mumbai
      56, 97,         // BSC + testnet
      43114, 43113,   // Avalanche + Fuji
      10, 420,        // Optimism + testnet
      42161, 421613,  // Arbitrum + testnet
    ];
